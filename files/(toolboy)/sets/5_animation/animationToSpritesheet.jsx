...
(function animationToSpritesheet(thisObj) {
    ...
    a2sData.strPNGWarning = { en: "Warning: Could not find \"PNG Sequence\" output template. It is highly recommended to either make a template by that name or import it by pressing [IMP REND] button under toolboy panel. Exporting as PSD for now." };
    ...
    function animationToSpritesheet_buildUI(thisObj) {
        ...
        if (pal !== null) {
            ...
            pal.grp.options.crp.box1.helpTip = animationToSpritesheet_localize(a2sData.strWarning);
            pal.grp.options.skp.list.helpTip = animationToSpritesheet_localize(a2sData.strFrameSkipHelpTip);
            pal.grp.options.sam.sld.helpTip = animationToSpritesheet_localize(a2sData.strSamplesHelpTip);
